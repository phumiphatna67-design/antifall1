...
const REMIX_SUGGESTIONS = [
  "Remix idea: Generate different gym backgrounds.",
  "Remix idea: Let users choose the workout action (e.g., lifting weights).",
  "Remix idea: Add different body types (e.g., lean, bulky).",
  "Remix idea: Generate a short workout video clip.",
  "Remix idea: Let users add gym apparel.",
  "Remix idea: Create a 'before and after' comparison GIF.",
];
